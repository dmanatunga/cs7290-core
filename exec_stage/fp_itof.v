...
module  fp_itof_altbarrel_shift_mvf
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //fp_itof_altbarrel_shift_mvf
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_itof_altpriority_encoder_3e8
	( 
	data,
	q,
	zero) ;
	...
	assign
		q = {data[1]},
		zero = (~ (data[0] | data[1]));
endmodule //fp_itof_altpriority_encoder_3e8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_itof_altpriority_encoder_6e8
	( 
	data,
	q,
	zero) ;
	...
	fp_itof_altpriority_encoder_3e8   altpriority_encoder15
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder15_q),
	.zero(wire_altpriority_encoder15_zero));
	fp_itof_altpriority_encoder_3e8   altpriority_encoder16
	( 
	.data(data[3:2]),
...
endmodule //fp_itof_altpriority_encoder_6e8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_itof_altpriority_encoder_be8
	( 
	data,
	q,
	zero) ;
	...
	fp_itof_altpriority_encoder_6e8   altpriority_encoder13
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder13_q),
	.zero(wire_altpriority_encoder13_zero));
	fp_itof_altpriority_encoder_6e8   altpriority_encoder14
	( 
	.data(data[7:4]),
...
endmodule //fp_itof_altpriority_encoder_be8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_itof_altpriority_encoder_rf8
	( 
	data,
	q,
	zero) ;
	...
	fp_itof_altpriority_encoder_be8   altpriority_encoder11
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder11_q),
	.zero(wire_altpriority_encoder11_zero));
	fp_itof_altpriority_encoder_be8   altpriority_encoder12
	( 
	.data(data[15:8]),
...
endmodule //fp_itof_altpriority_encoder_rf8
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_itof_altpriority_encoder_3v7
	( 
	data,
	q) ;
	input   [1:0]  data;
	...
	assign
		q = {data[1]};
endmodule //fp_itof_altpriority_encoder_3v7

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_itof_altpriority_encoder_6v7
	( 
	data,
	q) ;
	input   [3:0]  data;
	...
	fp_itof_altpriority_encoder_3v7   altpriority_encoder21
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder21_q));
	fp_itof_altpriority_encoder_3e8   altpriority_encoder22
	( 
	.data(data[3:2]),
...
endmodule //fp_itof_altpriority_encoder_6v7

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_itof_altpriority_encoder_bv7
	( 
	data,
	q) ;
	input   [7:0]  data;
	...
	fp_itof_altpriority_encoder_6v7   altpriority_encoder19
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder19_q));
	fp_itof_altpriority_encoder_6e8   altpriority_encoder20
	( 
	.data(data[7:4]),
...
endmodule //fp_itof_altpriority_encoder_bv7

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_itof_altpriority_encoder_r08
	( 
	data,
	q) ;
	input   [15:0]  data;
	...
	fp_itof_altpriority_encoder_bv7   altpriority_encoder17
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder17_q));
	fp_itof_altpriority_encoder_be8   altpriority_encoder18
	( 
	.data(data[15:8]),
...
endmodule //fp_itof_altpriority_encoder_r08

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_itof_altpriority_encoder_qb6
	( 
	data,
	q) ;
	input   [31:0]  data;
	...
	fp_itof_altpriority_encoder_rf8   altpriority_encoder10
	( 
	.data(data[31:16]),
	.q(wire_altpriority_encoder10_q),
	.zero(wire_altpriority_encoder10_zero));
	fp_itof_altpriority_encoder_r08   altpriority_encoder9
	( 
	.data(data[15:0]),
...
endmodule //fp_itof_altpriority_encoder_qb6

//synthesis_resources = lpm_add_sub 5 lpm_compare 1 reg 247 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_itof_altfp_convert_e1n
	( 
	clock,
	dataa,
	result) ;
	...
	fp_itof_altbarrel_shift_mvf   altbarrel_shift5
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	fp_itof_altpriority_encoder_qb6   altpriority_encoder2
	( 
	.data(prio_mag_int_a),
...
endmodule //fp_itof_altfp_convert_e1n
//VALID FILE
...
module fp_itof (
	...
	fp_itof_altfp_convert_e1n	fp_itof_altfp_convert_e1n_component (
				.clock (clock),
				.dataa (dataa),
				.result (sub_wire0));
