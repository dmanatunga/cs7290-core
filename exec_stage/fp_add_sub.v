...
module  fp_add_sub_altbarrel_shift_s4e
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //fp_add_sub_altbarrel_shift_s4e
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_add_sub_altbarrel_shift_hlb
	( 
	data,
	distance,
	result) ;
	...
	assign
		...
		sel_w = {distance[4:0]},
		smux_w = {((({26{(sel_w[4] & (~ dir_w[4]))}} & {sbit_w[113:104], pad_w[15:0]}) | ({26{(sel_w[4] & dir_w[4])}} & {pad_w[15:0], sbit_w[129:120]})) | ({26{(~ sel_w[4])}} & sbit_w[129:104])), ((({26{(sel_w[3] & (~ dir_w[3]))}} & {sbit_w[95:78], pad_w[7:0]}) | ({26{(sel_w[3] & dir_w[3])}} & {pad_w[7:0], sbit_w[103:86]})) | ({26{(~ sel_w[3])}} & sbit_w[103:78])), ((({26{(sel_w[2] & (~ dir_w[2]))}} & {sbit_w[73:52], pad_w[3:0]}) | ({26{(sel_w[2] & dir_w[2])}} & {pad_w[3:0], sbit_w[77:56]})) | ({26{(~ sel_w[2])}} & sbit_w[77:52])), ((({26{(sel_w[1] & (~ dir_w[1]))}} & {sbit_w[49:26], pad_w[1:0]}) | ({26{(sel_w[1] & dir_w[1])}} & {pad_w[1:0], sbit_w[51:28]})) | ({26{(~ sel_w[1])}} & sbit_w[51:26])), ((({26{(sel_w[0] & (~ dir_w[0]))}} & {sbit_w[24:0], pad_w[0]}) | ({26{(sel_w[0] & dir_w[0])}} & {pad_w[0], sbit_w[25:1]})) | ({26{(~ sel_w[0])}} & sbit_w[25:0]))};
endmodule //fp_add_sub_altbarrel_shift_hlb
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_add_sub_altfp_add_sub_ddk
	( 
	add_sub,
	clock,
	dataa,
...
`endif
	...
	fp_add_sub_altbarrel_shift_s4e   lbarrel_shift
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	fp_add_sub_altbarrel_shift_hlb   rbarrel_shift
	( 
...
endmodule //fp_add_sub_altfp_add_sub_ddk
//VALID FILE
...
module fp_add_sub (
	...
	fp_add_sub_altfp_add_sub_ddk	fp_add_sub_altfp_add_sub_ddk_component (
				.add_sub (add_sub),
				.clock (clock),
				.datab (datab),
				.dataa (dataa),
