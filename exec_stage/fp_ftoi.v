...
module  fp_ftoi_altbarrel_shift_rvf
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //fp_ftoi_altbarrel_shift_rvf

//synthesis_resources = lpm_add_sub 5 lpm_compare 4 reg 281 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_ftoi_altfp_convert_e1n
	( 
	clock,
	dataa,
	result) ;
	...
	fp_ftoi_altbarrel_shift_rvf   altbarrel_shift6
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
...
endmodule //fp_ftoi_altfp_convert_e1n
//VALID FILE
...
module fp_ftoi (
	...
	fp_ftoi_altfp_convert_e1n	fp_ftoi_altfp_convert_e1n_component (
				.clock (clock),
				.dataa (dataa),
				.result (sub_wire0));
